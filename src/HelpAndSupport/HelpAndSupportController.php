<?php
namespace WSChat\HelpAndSupport;

use WSChat\HelpAndSupport\Browser;
...
class HelpAndSupportController {
	...
	public static function load_faqs() {
		include WSCHAT_VIEW_PATH . 'admin/settings/help_support/faqs.php';

	}

	public static function load_raise_ticket() {

		include WSCHAT_VIEW_PATH . 'admin/settings/help_support/tickets.php';
	...
	public static function load_view() {
		...
		include WSCHAT_VIEW_PATH . 'admin/settings/help_support.php';
	}
	...
	public static function get_default_tab() {
		/**
		* Fire a filter hook for settings default tab
		*
		* @since 2.0.0
		*/
	...
	public static function display_output( $browser, $theme, $host, $WP_REMOTE_POST ) {
		global $wpdb;
		ob_start();
		$path = WSCHAT_VIEW_PATH . 'admin/settings/output.php';

		/**
		* Fire a filter hook for ssi view path output
		*
		* @since 2.0.0
		* @param $path
		*/
